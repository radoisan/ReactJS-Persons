Task: 
  ...
  2: Create a new component(=> ValidationComponent) which receives the text lenght as a prop

  3: Inside the ValidationComponent, either output "Text too short" or "Text is long enough"
  depending on the text lenght (e.g. take 5 as a minimum lenght)
...
Compare it with my solution (video + downloadable files) thereafter.
	...
	to complete task 5 of the assignment.
